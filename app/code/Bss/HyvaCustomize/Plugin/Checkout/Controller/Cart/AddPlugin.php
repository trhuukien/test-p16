<?php
namespace Bss\HyvaCustomize\Plugin\Checkout\Controller\Cart;
...
class AddPlugin extends \Magento\Checkout\Controller\Cart\Add
{
    /**
        ...
        try {
            ...
            if ($this->_checkoutSession->getUseNotice(true)) {
                ...
                foreach ($messages as $message) {
                    if (
                        $message != "De vereiste optie(s) van het product zijn niet ingevoerd. Zorg ervoor dat de opties zijn ingevoerd en probeer het opnieuw." &&
