...
class ShippingInformationManagementPlugin {
    ...
    QuoteRepository $quoteRepository, Data $bizHelper, Currency $Currency, proHelper $proHelper, Deliverydate $productDeliveryDate
    ) {
    ...
    ShippingInformationManagement $subject, $cartId, ShippingInformationInterface $addressInformation
        ...
        if ($this->_bizHelper->getOnWhichPage() == 1 || $this->_bizHelper->getOnWhichPage() == 2) {
            ...
            {
                $deliveryDate = $this->productDeliveryDate->getDeliveryDate();
            }
