...
namespace Biztech\Deliverydate\Model\Quote;
...
class TotalsCollector extends \Magento\Quote\Model\Quote\TotalsCollector {
    ...
    public function collect(\Magento\Quote\Model\Quote $quote) {
        ...
        foreach ($quote->getAllAddresses() as $address) {
            ...
            $address->setGrandTotal($address->getGrandTotal() + $address->getSameDayCharges() + $address->getDeliveryCharges());
            $address->setBaseGrandTotal($address->getBaseGrandTotal() + $address->getSameDayCharges() + $address->getDeliveryCharges());

            $total->setGrandTotal((float) $total->getGrandTotal() + $addressTotal->getGrandTotal() + $address->getSameDayCharges() + $address->getDeliveryCharges());
            $total->setBaseGrandTotal((float) $total->getBaseGrandTotal() + $addressTotal->getBaseGrandTotal() + $address->getSameDayCharges() + $address->getDeliveryCharges());
        }
