...
use Anowave\Ec\vendor\Google\Config as Google_Config;
use Anowave\Ec\vendor\Google\Auth\AbstractAuth as Google_Auth_Abstract;
use Anowave\Ec\vendor\Google\Auth\OAuth2 as Google_Auth_OAuth2;
use Anowave\Ec\vendor\Google\Auth\Exception as Google_Auth_Exception;
use Anowave\Ec\vendor\Google\IO\AbstractIO as Google_IO_Abstract;
  ...
  public function __construct($config = null)
  {
    ...
    if ($config->getIoClass() == Google_Config::USE_AUTO_IO_SELECTION) {
      if (function_exists('curl_version') && function_exists('curl_exec')
          && !$this->isAppEngine()) {
        $config->setIoClass("Anowave\\Ec\\vendor\Google\IO\Curl");
      } else {
        $config->setIoClass("Anowave\\Ec\\vendor\Google\IO\Stream");
      }
    }
